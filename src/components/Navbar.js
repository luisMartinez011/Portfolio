    ...
    <nav className={'fixed  w-64 md:w-72 xl:w-80 h-full m-0 p-0 font-mono '
      ...
      <div className={"flex flex-col h-screen  bg-red-400 relative xl:static divide-y-4 divide-solid text-zinc-50 text-xl"
        ...
        flex flex-col justify-center h-full w-full '>
          <NavLink to="/" className="w-full hover:bg-red-600 active:bg-red-700 p-10" style={linkStyle} onClick={handleNavbarToggle}>Home</NavLink>
          <NavLink to="/about" className="w-full hover:bg-red-600 active:bg-red-700 p-10" style={linkStyle} onClick={handleNavbarToggle}>About me</NavLink>
          <NavLink to="/projects" className="w-full hover:bg-red-600 active:bg-red-700 p-10" style={linkStyle} onClick={handleNavbarToggle}>Projects</NavLink>
          <NavLink to="contact" className="w-full hover:bg-red-600 active:bg-red-700 p-10" style={linkStyle} onClick={handleNavbarToggle}>Contact me</NavLink>
        </div>
